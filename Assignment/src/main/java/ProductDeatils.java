...
import com.training.ecommerceapp.util.FindProductException;
...
public class ProductDeatils {
	...
	public void StoreProduct() {
		...
		//ad.add(new ProductDeatils(1,"as",33,"des"));
	...
	public void displaybyname(String name)  throws Exception{
		Iterator<ProductDeatils> itr=ad.iterator();
		while(itr.hasNext())
			{
			System.out.println("***************************");
			...
			if(pr.Pname.equals(name)) {
				...
				System.out.println(pr);
				 ...
				 throw new FindProductException("Product  is not present");
			}
			}	
			System.out.println("***************************");
